document.addEventListener('DOMContentLoaded', () => {
    ...
    function showProposal() {
        ...
        setTimeout(() => {
            ...
            title.textContent = config.questionTitle || "Una pregunta...";

            question.textContent = config.bigQuestion || "¿Quieres ser mi San Valentín?";
    ...
    yesBtn.addEventListener('click', () => {
        ...
        setTimeout(() => {
            title.textContent = config.successTitle || "¡Siiiii! 🎉❤️";
            question.textContent = config.successMessage || "¡Sabía que dirías que sí! Te amo.";
